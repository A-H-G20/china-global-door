...
<html lang="en">
  ...
  <body>
    <div class="header">
      ...
      <div class="shopping">
        <a href="cart.php"><img src="image/shopping-cart.png" alt="Shopping Cart" /></a>
      </div>
    </div>
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo '<img src="http://localhost/china-global-door/admin/image/' . $row['image'] . '" alt="Product Image">';
            echo '</a>';
